                          ...
                          <table id="" class="table mb-0">
                              ...
                              <tbody>
                                  <tr v-for="(canvasData,i) in canvasAllData" :key="i">
                                    ...
                                    <td><img :src="BASE_URL+'storage/app/public/backend/images/canvas/pdf_platform/Canvas_screenshoot/'+canvasData.canvas_image" alt="No image" class="img-responsive img-thumbnail" width="150" height="100" style="border: 1px solid gray;"></td>
                                    ...
                                    <td>
                                      ...
                                      <b-button variant="danger" @click="deleteCanvas(canvasData.cmn_pdf_platform_canvas_id)"><b-icon icon="trash-fill" font-scale="1.2"></b-icon></b-button>
                                    </td>
                                  </tr>
                              </tbody>
                          </table>
