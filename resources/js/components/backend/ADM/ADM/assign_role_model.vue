							...
							<div class="col">
								<!-- <form> -->
									<div class="form-group row">
										...
										<div class="col-sm-4">
                       <multiselect v-model="user" :options="all_users" :searchable="true" :close-on-select="true" :show-labels="true" :placeholder="myLang.select_user" label="user_name" track-by="user_id" @select="showRoles($event)"><span slot="noOptions">候補がありません</span> <span slot="noResult">候補がありません</span></multiselect>
										</div>
									</div>
									<div class="form-group row">
