...
export default {
  ...
  methods: {
      getAllNoStockItem(page){
        ...
        this.form.page=page;
        axios.post(this.BASE_URL + "api/get_stock_item_list", this.form)
            .then(({ data }) => {
                // console.log(data)
      ...
      showAllItemCode(){
        ...
        axios.post(this.BASE_URL + "api/get_stock_item_code_list", this.form)
            .then(({ data }) => {
  ...
  mounted() {
      this.form = this.$store.getters['stockItemModule/getFormData'];
