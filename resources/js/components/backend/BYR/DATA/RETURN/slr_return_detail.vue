...
// Search
  ...
  methods: {
    ...
    deliverySearchForm1() {
      ...
      axios.post(this.BASE_URL + "api/slr_get_voucher_detail_popup1_return", this.$route.query)
        .then(({ data }) => {
            // console.log(data);
    ...
    deliverySearchForm2() {
      this.order_search_modal2 = true;
       this.$route.query.adm_user_id = Globals.user_info_id;
       this.$route.query.byr_buyer_id = this.form.byr_buyer_id;
      axios.post(this.BASE_URL + "api/slr_get_voucher_detail_popup2_return", this.$route.query)
        .then(({ data }) => {
    ...
    deliverySearchForm3() {
      this.order_search_modal3 = true;
       this.$route.query.adm_user_id = Globals.user_info_id;
       this.$route.query.byr_buyer_id = this.form.byr_buyer_id;
      axios.post(this.BASE_URL + "api/slr_get_voucher_detail_popup3_return", this.$route.query)
        .then(({ data }) => {
    ...
    get_all_receive_detail(page = 1) {
      let loadersss = Vue.$loading.show();
        this.form.page=page;
      axios
        .post(this.BASE_URL + "api/slr_data_return_detail_list", this.form)
        .then(({ data }) => {
  ...
  created() {
      this.form = this.$store.getters['slrReturnDetailsModule/getFormData'];
