...
class CreateDataOrderItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_order_items', function (Blueprint $table) {
            $table->increments('data_order_item_id')->unsigned()->comment('data_order_item_id');
            ...
            $table->date('mes_lis_ord_lin_ite_deadline_date')->comment('納品期限');
            ...
            $table->integer('mes_lis_ord_lin_amo_item_tax')->comment('税額');
            ...
            $table->decimal('mes_lis_ord_lin_fre_unit_weight', 10, 3)->default(0)->comment('取引単位重量');
            $table->string('mes_lis_ord_lin_fre_unit_weight_code', 2)->comment('単価登録単位');
            $table->decimal('mes_lis_ord_lin_fre_item_weight', 10, 3)->default(0)->comment('商品重量');
            $table->decimal('mes_lis_ord_lin_fre_order_weight', 10, 3)->default(0)->comment('発注重量');
    ...
    {
        Schema::dropIfExists('data_order_items');
    }
}
