...
namespace App\Http\Controllers\API\DATA\STOCK;
...
class StockItemController extends Controller
{
    public function stockItemList(Request $request)
    {
        ...
        // $table_name='dsi.';
        // if ($sort_by=="mes_lis_shi_tra_trade_number") {
        //     $table_name='data_shipment_vouchers.';
        // }
        ...
        $stock_items=$stock_items->whereNotNull('data_shipment_vouchers.send_datetime')
