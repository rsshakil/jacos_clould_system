...
class DataController extends Controller
{
    public static function getRtnData($request)
    {
        ...
        if ($request->page_title=='return_list') {
            ...
            $trade_number = $request->trade_number; // 配送温度区分
