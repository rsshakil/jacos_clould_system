...
// return $sort_by;
    ...
    public function returnDetailList(Request $request)
    {
        ...
        $result=data_return_voucher::select(
            ...
            ->join('data_returns', 'data_returns.data_return_id', '=', 'data_return_vouchers.data_return_id')
    ...
    public function returnDownload(Request $request)
    {
        ...
        if ($downloadType==1) {
            ...
            $return_query = DataController::getRtnData($request);
            $csv_data_count = $return_query['total_data'];
            $return_data = $return_query['return_data'];
