...
test('Invoice details download test by Sakaki Seller', async t => {
    var date = new Date();
...
function typeChecking(keyNum = 0) {
    ...
    var numberArray = [{ key: 0, length: 13 }, { key: 2, length: 13 }, { key: 6, length: 20 }, { key: 13, length: 8 },
        ...
        { key: 46, length: 13 }, { key: 49, length: 10 }, { key: 50, length: 10 }, { key: 52, length: 10 },
        { key: 57, length: 4 }, { key: 58, length: 2 }, { key: 59, length: 4 }
    ];
    var textArray = [{ key: 1, length: 4 }, { key: 3, length: 4 }, { key: 4, length: 20 }, { key: 5, length: 2 }, { key: 7, length: 30 },
        ...
        { key: 44, length: 20 }, { key: 47, length: 20 }, { key: 48, length: 20 }, { key: 53, length: 2 }
    ]
    var dateArray = [{ key: 8, length: 20 }, { key: 36, length: 10 }, { key: 37, length: 10 }, { key: 51, length: 10 }]
