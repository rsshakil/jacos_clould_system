...
test('Receive details download test by Sakaki Seller', async t => {
    var date = new Date();
    ...
    await t.maximizeWindow()
        ...
        // ========Order menu selected============
        .click(Selector('.nav-item').find('a').withText('受領確認'))
...
function typeChecking(keyNum = 0) {
    ...
    var numberArray = [{ key: 0, length: 13 }, { key: 2, length: 13 }, { key: 6, length: 20 }, { key: 13, length: 8 },
        ...
        { key: 32, length: 10 }, { key: 33, length: 10 }, { key: 34, length: 13 }, { key: 35, length: 13 }, { key: 38, length: 13 },
        { key: 39, length: 13 }, { key: 42, length: 13 }, { key: 43, length: 13 }, { key: 49, length: 13 }, { key: 50, length: 13 },
        { key: 53, length: 13 }, { key: 54, length: 13 }, { key: 60, length: 2 }, { key: 61, length: 2 }, { key: 62, length: 2 },
        { key: 63, length: 2 }, { key: 74, length: 10 }, { key: 75, length: 10 }, { key: 84, length: 2 }, { key: 87, length: 2 },
        { key: 88, length: 2 }, { key: 89, length: 2 }, { key: 90, length: 2 }, { key: 91, length: 2 }, { key: 92, length: 2 },
        { key: 95, length: 2 }, { key: 96, length: 2 }, { key: 97, length: 4 }, { key: 100, length: 10 }, { key: 101, length: 10 },
        { key: 102, length: 10 }, { key: 103, length: 6 }, { key: 104, length: 6 }, { key: 105, length: 14 }, { key: 106, length: 4 },
        { key: 111, length: 10 }, { key: 112, length: 10 }, { key: 117, length: 14 }, { key: 118, length: 14 }, { key: 119, length: 3 },
        { key: 120, length: 14 }, { key: 131, length: 4 }, { key: 151, length: 11 }, { key: 152, length: 15 }, { key: 153, length: 11 },
        ...
        { key: 164, length: 11 }, { key: 166, length: 10 }, { key: 168, length: 10 }, { key: 169, length: 10 },
        { key: 170, length: 10 }, { key: 171, length: 10 },
    ];
    ...
    var dateArray = [{ key: 8, length: 20 }, { key: 76, length: 10 }, { key: 77, length: 10 }, { key: 78, length: 10 },
        { key: 79, length: 10 }, { key: 80, length: 10 }, { key: 81, length: 10 }
    ]
